...
Il dataset utilizzato per questo studio è quello relativo alle olimpiadi dal 1896 al 2022.
...
bollePopMedaglie <- ggplot(
  ...
  scale_x_continuous(limits = c(3500, max(medagliepopolazione$popolazione)))
